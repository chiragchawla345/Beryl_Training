...
puts a.count("er")  #2
puts a.count(" ")   #1
puts a.count("erl","hol")  #0 find intersect string in arguments then count
puts a.count("ho")  #3
puts a.count("ello","oldw")  #5
puts a.count("r-w")  #2 characrters between r & w inclusive
...
"hello\bworld".each_line {|s| print s+" "}  #no seperation
puts "New line"
...
#include
puts "hello".include? "eo"  #checks passing string is a substring of calling string or not
puts "hello world".include? " "
puts "hello world".include? "ell"
...
#match
puts 'hello'.match(/.l./)     #Return matched string
puts 'hello'=~/.l./ 
